...
import com.example.ifraneguard.dto.request.StatusUpdateRequest;
...
public class AuthorityController {
    ...
    public ResponseEntity<ApiResponse<?>> getNotifications(@AuthenticationPrincipal User authority) {
        var notifications = notificationService.getUnreadNotifications(authority);
