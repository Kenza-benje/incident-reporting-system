 ...
 *
 * Implements UserDetails directly so that @AuthenticationPrincipal User in controllers
 * receives the actual entity — no Spring Security wrapper, no extra DB call.
 *
